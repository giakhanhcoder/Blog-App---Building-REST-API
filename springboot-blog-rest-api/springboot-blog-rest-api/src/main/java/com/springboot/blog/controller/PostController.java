...
public class PostController {
    ...
    @Operation(
            ...
            description = "Get All Posts By Id REST API is used to fetch all the posts from the database"
    )
    @ApiResponse(
            responseCode = "200",
...
//    @GetMapping("/api/v1/posts/{id}")
    ...
    @Operation(
            summary = "Get Post By Id V2 REST API",
            description = "Get Post By Id V2 REST API is used to get single post from the database"
    )
    @ApiResponse(
            responseCode = "200",
            description = "Http Status 200 SUCCESS"
...
//    @GetMapping("/api/v2/posts/{id}")
    ...
    @Operation(
            ...
            description = "Get Post By CategoryId REST API is used to get posts from the database"
    )
    @ApiResponse(
            responseCode = "200",
            description = "Http Status 200 SUCCESS"
