...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    // approach 2 thi bo extend ResponseEntityExceptionHandler
...
//        });
//
//        ErrorDetails errorDetails = new ErrorDetails(new Date(), errors.toString(), webRequest.getDescription(false));
//
//        return new ResponseEntity<>(errorDetails, HttpStatus.BAD_REQUEST);
//    }
